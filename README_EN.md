...
![GitHub commits since](https://img.shields.io/github/commits-since/GwendolyneFreddy/LCC-Readme/v5.0.0.svg?style=plastic)
[![GitHub commits since](https://img.shields.io/github/commits-since/GwendolyneFreddy/LCC-Readme/v5.0.0.svg?style=plastic)]() 
...
| :---: | --- | :---: | :---: | :---: |
| mymod_variable1 | blabla<br>1 = first option description (recommended).<br>2 = second value description.<br> | integer | 1 or 2 | <strong>1<strong> |
| mymod_variable2 | blabla<br>1 = first option description (recommended).<br>2 = second value description.<br>3 = third value description.<br> | integer | 1, 2 or 3 | <strong>1<strong> |
